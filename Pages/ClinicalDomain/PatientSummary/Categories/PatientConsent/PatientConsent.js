...
class ConsentPage {
    constructor(page) {
        ...
        this.bloodTransfusionCheckbox = 'input[type=checkbox][aria-label="Blood transfusion"]';
        this.otherProceduresCheckbox = 'input[type=checkbox][aria-label="Other procedures (please specify)"]';
        this.followingInformationCheckbox = 'input[type=checkbox][aria-label="The following information has been provided"]';
