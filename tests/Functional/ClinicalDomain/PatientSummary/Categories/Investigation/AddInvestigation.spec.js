     ...
     // await contacthistory.enterContactDate("26/04/2024");
      ...
      await page.waitForTimeout(2000)
       ...
       // await Investigations.clickOnItemReview(jsonData.AddInvestigation[index].pacr_que_name);
        ...
        await Investigations.clickOnItemEdit(jsonData.AddInvestigation[index].pacr_que_name);
...
await page.pause()
    ...
    //  await InvestigationsExtraDetails.clickOnClincialItemCollapsable();
     ...
     // await InvestigationsExtraDetails.selectRequestedBy(jsonData.AddInvestigation[index].requested_by);
      await InvestigationsExtraDetails.selectInvSendTo(jsonData.AddInvestigation[index].sendTo);
    ...
    await Investigations.toggleSearchSection(); //Close the search section
      ...
      await page.getByRole('textbox', { name: 'valueundefinedsubTest0' }).fill('65');
      await page.getByRole('textbox', { name: 'targetnullsubTest0' }).click();
      await page.getByRole('textbox', { name: 'targetnullsubTest0' }).fill('65');
...
//getByLabel('valueundefinedsubTest0').first()
